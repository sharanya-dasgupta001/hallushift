...
class CombinedNN(nn.Module):
    ...
    This module takes Wasserstein and cosine distances from hidden states and attention layers,
    embeds them using separate feature embedding networks, concatenates these embeddings
    with additional probabilistic features, and finally passes the combined features
    through a fully connected network to predict hallucination probabilities.
    """
